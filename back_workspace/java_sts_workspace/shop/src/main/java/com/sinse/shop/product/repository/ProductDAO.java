...
public class ProductDAO {
	...
	// 원하는 수만큼의 최신 상품 가져오기
	public List<Product> slectRecentList(int limit) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		con = dbManager.getConnetion();
		StringBuffer sql = new StringBuffer();
		// 상품과 서브분류 조인 후 , 1:다 관계에 있는 product_img, product_size, product_color
     	 // 서브쿼리로 가져오자 최종결과는 모두 프로덕트 모델에 심어져야함
